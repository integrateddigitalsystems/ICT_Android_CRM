...
public class EventParserHandler extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException
    {
    	if(qName.equalsIgnoreCase("IssueType")) {
		...
		}else if (qName.equalsIgnoreCase("ShowOnMap")) {
			tempEvent.setShowMap(tempVadesc);
			...
			tempEvent.setServiceProviderTransfer(tempVal);
		}else if (qName.equalsIgnoreCase("AMLogo")) {
			tempEvent.setImageUrlDay(tempVadesc);
			tempEvent.setThumbnailUrlDay(tempVadesc);
		}else if (qName.equalsIgnoreCase("PMLogo")) {
			tempEvent.setImageUrlNight(tempVadesc);
			tempEvent.setThumbnailUrlNight(tempVadesc);
