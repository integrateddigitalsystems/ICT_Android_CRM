 	            ...
 	            this.listMenu.setOnItemClickListener(new OnItemClickListener() {
 	    			...
 	    			public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
 	    				...
 	    				if(position==0 || position ==10){
 	    					...
 	    					//use Bundle to send store data to be send to StockListActivity
	...
	protected class LaunchingEvent extends AsyncTask<Void,Void,Integer>{
		...
		protected Integer doInBackground(Void... params) {
			...
			AtomicReference <Mail_OFF[]> ref=new AtomicReference<Mail_OFF[]>(null);
			  TCTDbAdapter source = new TCTDbAdapter(ReportsNotificationListActivity.this);
		        source.open();
		...
		protected void onPostExecute(Integer result){
				...
				ReportsNotificationListArrayAdapter adapter  = new ReportsNotificationListArrayAdapter( ReportsNotificationListActivity.this ,nn);
