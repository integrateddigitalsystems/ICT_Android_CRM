...
public class Facebook1Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("http://twitter.com/home?status=" + get_text());
    ...
    private String get_text() {
        ...
        try {
            ...
            URL url = new URL("" + app.link + "GeneralServices.asmx/GetSocialMediaSharingText?password=&language=en");
...
//	website = new TextView[nodeList.getLength()];
    ...
    private void webpageSettings() {
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                if (!pd.isShowing())
                    try {
                        pd = ProgressDialog.show(Facebook1Activity.this, "", Facebook1Activity.this.getString(R.string.loading), true, true);
                    } catch (Exception e) {
    ...
    protected class LaunchingEvent extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            TCTDbAdapter source = new TCTDbAdapter(Facebook1Activity.this);
            source.open();
...
//nn1  = ref.get();
        ...
        protected void onPostExecute(Integer result) {
            ...
            //	}
            //	else{
            //	EventsListArrayAdapterMenu adapter  = new EventsListArrayAdapterMenu( Facebook1Activity.this ,nn);
